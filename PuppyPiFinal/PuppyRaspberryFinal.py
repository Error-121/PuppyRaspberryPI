...
# Lyde
loud_bark = pygame.mixer.Sound('/Loud.wav')  # Høj gø-lyd
quiet_bark = pygame.mixer.Sound('/Quiet.mp3')  # Stille gø-lyd
silent_bark = pygame.mixer.Sound('/growl.wav')  # Knurren
want_inside_bark = pygame.mixer.Sound('/Inside.mp3')  # Lyd for at komme ind
